...
public class MaterialController {
    ...
    // GET /api/materiales  (opcional: ?materiaId=1)
    @GetMapping
    ...
    public ResponseEntity<MaterialResponse> crearMaterial(
        ...
        MaterialResponse response = MaterialResponse.builder()
                ...
                .materiaNombre(material.getMateria().getName())
                .materiaCodigo(material.getMateria().getCode())
                .usuarioNombre(material.getUsuario().getNombreUsuario())
                .build();
